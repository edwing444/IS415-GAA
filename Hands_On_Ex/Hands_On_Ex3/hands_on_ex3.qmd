...
[Challenge: Do you know what are the differences between Spatial\* classes and generic sp object?]{.underline}
...
1.  '**SpatialPoints**': Represents spatial data as a set of points. Each point is defined by coordinates in a spatial reference
