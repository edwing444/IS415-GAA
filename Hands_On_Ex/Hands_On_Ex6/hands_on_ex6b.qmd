...
>
> -   **High-high clusters:** There are several high-high clusters, indicating areas where the GDPPC is high and surrounded by other areas with high GDPPC. These clusters may suggest that certain factors, such as economic policies, infrastructure, or natural resources, are conducive to high economic growth in these regions.
>
> ```{=html}
> <!-- -->
> ```
> -   **Low-low clusters:** There are also some low-low clusters, indicating areas with low GDPPC that are surrounded by other areas with low GDPPC. These clusters may suggest that these regions face challenges such as lack of economic opportunities, infrastructure, or natural resources that hinder their economic development.
...
>
> -   **Hotspots:** Areas with high positive Gi values indicate clusters of high GDPPC surrounded by other areas with high GDPPC. These areas are considered hotspots and may suggest that certain factors, such as economic policies, infrastructure, or natural resources, are conducive to high economic growth in these regions.
>
> -   **Coldspots:** Areas with high negative Gi values indicate clusters of low GDPPC surrounded by other areas with low GDPPC. These areas are considered coldspots and may suggest that these regions face challenges such as lack of economic opportunities, infrastructure, or natural resources that hinder their economic development.
>
> -   **Spatial outliers:** Areas with low positive or negative Gi values indicate spatial outliers, where the GDPPC is significantly different from the surrounding areas. These outliers may suggest that factors such as trade, migration, or government policies are influencing the economic development of these regions.
