...
```{r}
#| eval: false
pacman::p_load(sf, tmap, tidyverse,spatstat,raster,terra,stpp)
```
...
conflict_data <- read_csv("data/acled_mm.csv")
...
```{r}
boundary_data <- st_read(dsn="data",
                         layer = "mmr_polbnda_self_administered_zones_1")
```
...
utm_crs <- st_crs(32648)  # UTM Zone 48N
